	...
	return (
		<header className="max-w-[120rem] w-full mx-auto h-[8rem] flex justify-between items-center p-4">
			...
			<div className="flex items-start gap-4">
				<Link href={"/movies"}>
					<div className="py-3 px-4 text-link text-gray-50 cursor-pointer">AI Agent</div>
				</Link>
				<div className="py-3 px-4 text-link text-gray-50 cursor-pointer">GPT</div>
				<div className="flex items-center gap-2">
					...
					<Link href="/login" className="flex gap-2 py-3 px-4 cursor-pointer">
						...
						<span className="text-link text-gray-50">Log in</span>
					</Link>
				</div>
			</div>
		</header>
